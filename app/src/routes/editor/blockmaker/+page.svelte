...
func: "${functionName}",
text: "${text}",
inline: ${inline},${selectedOutputType == "none" ? "" : (`\noutput: OutputType.${selectedOutputType},`)}${selectedBlockShape == "none" ? "" : (`\nshape: BlockShape.${selectedBlockShape},`)}
${arguments_block.length == 0 ? "" : (
    `arguments: {
        ${arguments_block.map((arg) => {
    ...
    <div class="mt-[64px] w-full flex">
        ...
        <div class="w-full">
            ...
            <div>
                ...
                <input type="text" id="functionName" name="functionName" bind:value={functionName} on:change={reloadBlock} />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="checkbox" id="inline" name="inline" bind:checked={inline} on:change={reloadBlock} />
            </div>
            <div>
                <label for="functionCode">Function Code:</label>
                <textarea id="functionCode" name="functionCode" bind:value={functionCode} on:change={reloadBlock}/>
            </div>
            <div>
                <label for="outputType">Output Type:</label>
                <select id="outputType" name="outputType" bind:value=
                {selectedOutputType} on:change={reloadBlock}>
            ...
            <div>
                ...
                <select id="blockShape" name="blockShape" bind:value={selectedBlockShape} on:change={reloadBlock}>
                    <option value="none">None</option> 
            ...
            <div>
                ...
                <select id="inputShape" name="inputShape" bind:value={selectedInputShape} on:change={reloadBlock}>
                    <option value="none">None</option> 
