                    ...
                    arguments: {
                        EVENT: {
                            ...
                            options: [
                                ...
                                ["no longer has outage", "guildAvailable"],
                                ["bot is removed", "guildDelete"],
                                ["bot is added", "guildCreate"],
                            ],
                        },
                    },
                },
                        ...
                        DATA: {
                            ...
                            options: [
                                ...
                                [
                                    ...
                                    "discoverySplashURL({ dynamic: true })",
                                ],
                                ...
                                [
                                    ...
                                    "channels.cache.filter(m => m.type === Discord.ChannelType.GuildVoice).size",
                                ],
                                [
                                    "Number of text channels",
                                    "channels.cache.filter(m => m.type === Discord.ChannelType.GuildText).size",
                                ],
                                ["MFA level", "mfaLevel"],
                                ["Name", "name"],
